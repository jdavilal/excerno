...
test_that("Output is correct", {
  ...
  expect_true(classify.gr$start[1] == 11332)
  expect_true(classify.gr$REF[1] == "T")
  ...
  expect_true(classify.gr$ALT[1] == "A")
  expect_true(classify.gr$INFO[1] == "SOMATIC;TRUTH=SBS4")
  expect_true(classify.gr$QUAL[1] == 75)
  expect_true(classify.gr$FILTER[1] == "PASS")
  expect_true(classify.gr$FORMAT[1] == "GT:GQ")
  expect_true(classify.gr$SAMPLE1[1] == "0/0:58")
  expect_true(classify.gr$SAMPLE2[1] == "0/0:69")
})
